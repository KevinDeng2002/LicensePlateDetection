...
def get_parser():
    ...
    # parser.add_argument('--train_img_dirs', default="G:\plate\LicensePlate-master\data\preprocessed\ccpd_val_split",help='the train images path')
    parser.add_argument('--train_img_dirs', default=r"G:\plate\LicensePlate-master\data\preprocessed\train",
                        help='the train images path')
    parser.add_argument('--test_img_dirs', default="G:\plate\LicensePlate-master\data\preprocessed\lpr_test",
    ...
    parser.add_argument('--pretrained_model', default='./weights/LPRNet_model.pth', help='pretrained base model')
...
def train():
    ...
    lprnet.load_state_dict(torch.load(r'G:\plate\LPRNet_Pytorch-master\weights/Final_LPRNet_model.pth'))
    ...
    if args.pretrained_model:
        ...
        Stn.backbone.apply(weights_init)
        Stn.container.apply(weights_init)
        print("initial net weights successful!")
    ...
    for iteration in range(start_iter, max_iter):
        ...
        if iteration != 0 and iteration % args.save_interval == 0:
            ...
            torch.save(Stn.state_dict(), args.save_folder + 'STNNet_' + '_iteration_' + repr(iteration) + '.pth')
    ...
    torch.save(lprnet.state_dict(), r'G:\plate\LPRNet_Pytorch-master\weights/Final_LPRNet_model.pth')
    torch.save(Stn.state_dict(), args.save_folder + 'Final_STN_model.pth')
